...
public class RentalView extends JFrame{
	...
	private Transaction aTrans = new Transaction(); // class Transaction as global declaration
	private Customer aCustomer = new Customer(); //class Customer as global declaration
	private Car aCar = new Car(); // class car as global declaration
...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//-------------------------------------------------setting PANEL and LABELS for Welcome section
	    ...
	    ImageIcon titleImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\logo1.GIF");
	...
	//------------------------------------BUTTONS to go reserve section
		ImageIcon mainNextImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\next.GIF");
		mainNextB = new JButton(mainNextImage);
                mainNextB.setText("<html><span style='color: white; background-color: black;'>Next</span></html>");  
                mainNextB.setHorizontalTextPosition(SwingConstants.CENTER); 
                mainNextB.setVerticalTextPosition(SwingConstants.CENTER);  
 
		mainNextB.setBackground(Color.GREEN);
	...
	//-----------------------------------------------to go customer section
		ImageIcon dateNextImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\customer.GIF");
                mainNextB.setText("<html><span style='color: white; background-color: black;'>Next</span></html>");  
                mainNextB.setHorizontalTextPosition(SwingConstants.CENTER); 
                mainNextB.setVerticalTextPosition(SwingConstants.CENTER); 
		reserveNextB = new JButton(dateNextImage);
		reserveNextB.setBackground(Color.GREEN);
	...
	//---------------------------------------------------to go back welcome section
		ImageIcon dateBackImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\back.GIF");
                
		reserveBackB = new JButton(dateBackImage);
		reserveBackB.setBackground(Color.RED);
	...
	//----------------------------------------------to go pick a car section
		ImageIcon customerNextImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\car.GIF");
	...
	//--------------------------------------------to go back reserve section
		ImageIcon customerBackImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\customer_back.GIF");
		customerBackB = new JButton(customerBackImage);
		customerBackB.setBackground(Color.RED);
	...
	//---------------------------------------------------------Pick Car Buttton]
	//-------------------------------------first car button
		ImageIcon firstCarImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\van.gif");
	...
	//---------------------------------second car button
		ImageIcon secondCarImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\pickup.GIF");
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\limousine.gif");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\bentley.gif");
	...
	//-------------------------------------------------to go receipt section (Final step)
		ImageIcon carNextImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\submit.GIF");
		carNextB = new JButton(carNextImage);
		carNextB.setBackground(Color.GREEN);
	...
	//--------------------------------------------------------------------to go back customer section
		...
		ImageIcon carBackImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\car_back.GIF");
		carBackB = new JButton(carBackImage);
		carBackB.setBackground(Color.RED);
			...
			if(event.getActionCommand().equals("NextToCustomer")) {
				...
				if(aTrans.toStringDateChecker().equals("TRUE") && aTrans.toStringAgeChecker().equals("TRUE")) { //checker to proceed next panel
					...
					if(openWarningReserve == null){
						...
						ImageIcon warningReserveImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\warning_top_icon.GIF");
			...
			if(event.getActionCommand().equals("NextToPickCar")) {
				...
				if(!aCustomer.getFirstName().equals("Type First Name Here") && !aCustomer.getLastName().equals("Type Last Name Here") && !aCustomer.getGender().equals("M/F") && !aCustomer.getStatus().equals("S/Ma") && !aCustomer.getLocation().equals("Type Complete Address Here") && !aCustomer.getContact().equals("Type Contact Number Here")){
					...
					if(openWarningCustomer == null){
						...
						ImageIcon warningCustomerImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\warning_top_icon.GIF");
	...
	private class finalStepButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			else { // customer havent yet pick a car, show's the warning information 
				if(openWarningCar == null){
					openWarningCar = new WarningCar();
					ImageIcon warningCarImage = new ImageIcon("C:\\\\Users\\\\RAJ\\\\Downloads\\\\Romy Car Rental\\\\images\\\\warning_top_icon.GIF");

...
public class Transaction {
	...
	private Customer aCustomer; //Customer class in directory
	private Car aCar; //Car class in directory
...
///////////////////////for getting How many days Car has been rented/////////////////
	public int getDays() {
        // Ensure that month values are correctly converted from string month names to numerical values.
        LocalDate pickupDate = LocalDate.of(getPickYear(), monthNameToNumber(getPickMonth()), getPickDate());
        LocalDate returnDate = LocalDate.of(getReturnYear(), monthNameToNumber(getReturnMonth()), getReturnDate());
        
        // Check if the return date is before the pickup date to handle invalid date ranges
    ...
    // Helper method to convert month names to their corresponding numerical values (1-12)
...
//////////////////////////////////////////show all for customer///////////////////////////////////
	public String toStringReceipt() {
		...
		outMe += String.format("                                      Rajhans, Rashika And Rajas\n");
